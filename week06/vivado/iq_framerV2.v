...
`timescale 1 ns / 1 ps
	...
	reg [18:0] s_counter;
	wire [18:0] count_to;
	assign count_to = (control==4'b0010) ? 18'h0FFFF : 18'h3FFFF; //65535 or 262143 default
    ...
    assign m00_axis_tdata = control==1?{count_to[15:0], count_to[15:0]}: // display value we're counting to
    ...
    always @(posedge s00_axis_aclk) begin
        if (s00_axis_aresetn==0) begin
            ...
            if (s00_axis_tvalid && s01_axis_tvalid) begin
                ...
                probe <= (probe == 4'h8) ? 4'b0001 : probe << 1;
            end
        end
    end
