...
proc create_ipi_design { offsetfile design_name } {
	...
	set fir_interface_0 [ create_bd_cell -type ip -vlnv localdomain:user:fir_interface:1.0 fir_interface_0 ]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores localdomain:user:fir_interface:1.0]]]]
